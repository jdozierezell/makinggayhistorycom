 ...
 */
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
				...
				<?php 
				if ( 'email' === get_field( 'h_top_banner' ) ) :
					get_template_part( 'template-parts/mailchimp' ); 
				elseif ( 'donation' === get_field( 'h_top_banner' ) ) :
					get_template_part( 'template-parts/donation' );
				else :
					// nothing
				endif;
				if ( get_field( 'h_intro_copy' ) ) :
					echo '<section class="home-intro">';
					echo get_field( 'h_intro_copy' );
					echo '</section>';
				endif;
				?>
        ...
        <?php if(get_field('h_display') === 'featured') :
          
          $post_object = get_field('h_episode');
          if($post_object) :
            $post = $post_object;
            setup_postdata( $post );
            ...
            $thumb = $image['sizes']['square']; ?>
				...
				<div class="podcasts__latest">
					<h2 class="featured-title">Our Featured Episode</h2>
        ...
        elseif(get_field('h_display') === 'season') : ?>
      ...
      <section class="seasons-links">
        ...
        <?php endif; ?>
				...
				<?php 
				if ( 'email' === get_field( 'h_bottom_banner' ) ) :
					echo '<div class="mailchimp-bottom">';
					get_template_part( 'template-parts/mailchimp' ); 
					echo '</div>';
				elseif ( 'donation' === get_field( 'h_bottom_banner' ) ) :
					get_template_part( 'template-parts/donation' );
				else :
					// nothing
				endif;
